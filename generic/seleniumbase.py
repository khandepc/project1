...
class SeleniumBase:
    ...
    def perform_actions(self,element,action_type,value=None,other=None):
        return_value = None
    ...
    @staticmethod
    def perform_mouse_keyboard_actions(action_type,element,source_element=None, dest_element=None, value=None):
